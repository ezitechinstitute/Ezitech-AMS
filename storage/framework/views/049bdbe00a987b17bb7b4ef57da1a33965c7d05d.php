...
<head>
    ...
    <title><?php echo e((\App\Models\Utility::getValByName('title_text')) ? \App\Models\Utility::getValByName('title_text') : config('app.name', 'Ezitech AMS')); ?>  <?php echo $__env->yieldContent('page-title'); ?></title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                <p class="text-body"><?php echo e((\App\Models\Utility::getValByName('footer_text')) ? \App\Models\Utility::getValByName('footer_text') :  __('Copyright Ezitech AMS')); ?> <?php echo e(date('Y')); ?></p>
            </div>
        </div>
    </div>
</section>
