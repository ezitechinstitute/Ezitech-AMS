                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $mouzas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mouza): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($mouza->area_display); ?></td>
                                        <td><span class="badge bg-info"><?php echo e($mouza->fields_count); ?></span></td>
                                        <td><span class="badge bg-danger">🔴 <?php echo e($mouza->available_fields_count); ?></span>
                                        </td>
                                        <td><span class="badge bg-success">🟢 <?php echo e($mouza->sold_fields_count); ?></span></td>
                                        <td>
                                            <a href="<?php echo e(route('mouza.show', $mouza->id)); ?>" class="btn btn-sm btn-info"
                                                title="View & Map">
                                            ...
                                            <form action="<?php echo e(route('mouza.destroy', $mouza->id)); ?>" method="POST"
                                                class="d-inline" onsubmit="return confirm('Delete this Mouza?')">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
                                        <td colspan="8" class="text-center"><?php echo e(__('No Mouza found.')); ?></td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AMS\main_file\resources\views/realEstate/mouza/index.blade.php ENDPATH**/ ?>