...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Create Construction Project')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Add New Construction Project')); ?></h5>
                </div>
                <div class="card-body">
                    <?php if($errors->any()): ?>
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('construction-project.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label class="form-label"><?php echo e(__('Project Name')); ?> <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="name" class="form-control" required
                                        value="<?php echo e(old('name')); ?>" placeholder="e.g. Gulberg">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="tehsil" class="form-control" value="<?php echo e(old('tehsil')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="alert alert-light border mb-3">
                                    <h6 class="mb-3"><i class="ti ti-file-text"></i> <?php echo e(__('Master Intiqal Info')); ?>

                                        <small
                                            class="text-muted fw-normal">(<?php echo e(__('bulk purchase record for this whole project, if applicable')); ?>)</small>
                                    </h6>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="intiqal_number" class="form-control"
                                                    value="<?php echo e(old('intiqal_number')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" name="intiqal_date" class="form-control"
                                                    value="<?php echo e(old('intiqal_date')); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="latitude" id="latitude" class="form-control"
                                        value="<?php echo e(old('latitude')); ?>" placeholder="e.g. 31.5204" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="longitude" id="longitude" class="form-control"
                                        value="<?php echo e(old('longitude')); ?>" placeholder="e.g. 74.3587" readonly>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="map-hint"
                                class="text-muted"><?php echo e(__('Click on the map or drag the pin to set project location.')); ?></small>
                        </div>

                        <div class="text-end mt-3">
                            <a href="<?php echo e(route('construction-project.index')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2026\Ezitech-AMS-main\resources\views/constructionProject/create.blade.php ENDPATH**/ ?>