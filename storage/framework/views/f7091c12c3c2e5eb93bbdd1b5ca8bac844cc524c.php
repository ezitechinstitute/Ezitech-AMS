...
<footer class="dash-footer">
    <div class="footer-wrapper">
        <div class="py-1">
            <span class="text-muted">  <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright Ezitech AMS')); ?> <?php echo e(date('Y')); ?></span>
        </div>
        <div class="py-1">
...
<?php /**PATH C:\xampp\htdocs\AMS\main_file\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>