...
<?php endif; ?> -->
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage user')): ?>
                        <li class="dash-item">
                            <a href="<?php echo e(route('users.index')); ?>"
                                class="dash-link <?php echo e(Request::route()->getName() == 'users.index' || Request::route()->getName() == 'users.create' || Request::route()->getName() == 'users.edit' ? ' active' : ''); ?>">
                    ...
                    <?php if(Gate::check('manage user') || Gate::check('manage role')): ?>
                        <li
                            ...
                            <a href="#!" class="dash-link "><span class="dash-micon"><i
                                    ...
                                    class="dash-mtext"><?php echo e(__('Staff')); ?></span>
                                <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                            </a>
                            <ul
                ...
                <?php if(Gate::check('manage mouza') || Gate::check('manage plot')): ?>
                    <li
                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'mouza' || Request::segment(1) == 'plot' ? ' active dash-trigger' : ''); ?>">
                        ...
                        <ul
                            class="dash-submenu <?php echo e(Request::segment(1) == 'mouza' || Request::segment(1) == 'plot' ? 'show' : ''); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage plot')): ?>
                                <li
                                    class="dash-item <?php echo e(Request::segment(1) == 'plot' && Request::segment(2) != 'inventory' ? 'active' : ''); ?>">
                ...
                <?php if(Gate::check('manage construction project')): ?>
                    <li
                        class="dash-item dash-hasmenu <?php echo e(Request::segment(1) == 'construction-project' ? ' active dash-trigger' : ''); ?>">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-building"></i></span>
                            <span class="dash-mtext"><?php echo e(__('Construction Project Gulberg')); ?></span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul class="dash-submenu <?php echo e(Request::segment(1) == 'construction-project' ? 'show' : ''); ?>">
                            <li class="dash-item <?php echo e(Request::segment(2) == 'fields' ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('construction-project.field.index')); ?>">
                                    <i class="ti ti-map-pin me-1"></i><?php echo e(__('Agricultural Land')); ?>

                                </a>
                            </li>
                            <li class="dash-item <?php echo e(Request::segment(2) == 'plots' ? 'active' : ''); ?>">
                                <a class="dash-link" href="<?php echo e(route('construction-project.plot.index')); ?>">
                                    <i class="ti ti-layout-grid me-1"></i><?php echo e(__('Plots')); ?>
...
<?php endif; ?> -->
                    ...
                    <li
                        ...
                        <ul
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage proposal')): ?>
                                <li
                                    class="dash-item <?php echo e(Request::route()->getName() == 'proposal.index' || Request::route()->getName() == 'proposal.create' || Request::route()->getName() == 'proposal.edit' ? ' active' : ''); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage retainer')): ?>
                                <li
                                    class="dash-item <?php echo e(Request::route()->getName() == 'retainer.index' || Request::route()->getName() == 'retainer.create' || Request::route()->getName() == 'retainer.edit' ? ' active' : ''); ?>">
                                    <a class="dash-link"
                                        href="<?php echo e(route('retainer.index')); ?>"><?php echo e(__('Retainers')); ?></a>
                ...
                <?php if(Gate::check('manage plan')): ?>
                    <li
                        class="dash-item <?php echo e(Request::segment(1) == 'plans' || Request::segment(1) == 'stripe' ? 'active' : ''); ?>">
                    ...
                    <li
                        ...
                        <ul
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('cash flow report')): ?>
                                <li
                                    class="dash-item <?php echo e(Request::route()->getName() == 'report.cash.flow' ? ' active' : ''); ?>">
                                    <a class="dash-link"
                                        href="<?php echo e(route('report.cash.flow')); ?>"><?php echo e(__('Cash Flow')); ?></a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\AMS\main_file\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>