...
<head>
    <title><?php echo e((Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Ezitech AMS')); ?> - <?php echo $__env->yieldContent('page-title'); ?></title>
        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 ">
                        <p class="">
                            <?php echo e((Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright Ezitech AMS')); ?> <?php echo e(date('Y')); ?>
