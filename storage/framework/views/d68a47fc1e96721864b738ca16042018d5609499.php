...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Edit Construction Project')); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Edit Construction Project')); ?>: <?php echo e($project->name); ?></h5>
                </div>
                <div class="card-body">
                    <?php if($errors->any()): ?>
                    ...
                    <?php endif; ?>
                    <form action="<?php echo e(route('construction-project.update', $project->id)); ?>" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="district" class="form-control"
                                        value="<?php echo e(old('district', $project->district)); ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="tehsil" class="form-control"
                                        value="<?php echo e(old('tehsil', $project->tehsil)); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="alert alert-light border mb-3">
                                    <h6 class="mb-3"><i class="ti ti-file-text"></i> <?php echo e(__('Master Intiqal Info')); ?></h6>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <label class="form-label"><?php echo e(__('Intiqal Number')); ?></label>
                                                <input type="text" name="intiqal_number" class="form-control"
                                                    value="<?php echo e(old('intiqal_number', $project->intiqal_number)); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" name="intiqal_date" class="form-control"
                                                    value="<?php echo e(old('intiqal_date', $project->intiqal_date)); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="total_area" class="form-control"
                                                    value="<?php echo e(old('total_area', $project->total_area)); ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="total_area_unit" class="form-control">
                                                    <?php $__currentLoopData = ['Marla', 'Kanal', 'Acre', 'Sq Ft']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($unit); ?>"
                                                            <?php echo e(old('total_area_unit', $project->total_area_unit) == $unit ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="latitude" id="latitude" class="form-control"
                                        value="<?php echo e(old('latitude', $project->latitude)); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="longitude" id="longitude" class="form-control"
                                        value="<?php echo e(old('longitude', $project->longitude)); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="map-hint"
                                class="text-muted"><?php echo e(__('Click on the map or drag the pin to update project location.')); ?></small>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2026\Ezitech-AMS-main\resources\views/constructionProject/edit.blade.php ENDPATH**/ ?>