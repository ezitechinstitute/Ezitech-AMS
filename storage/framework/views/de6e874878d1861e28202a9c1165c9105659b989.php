...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Real Estate - Plots')); ?>
                    ...
                    <table class="table datatable">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $plots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('plot.show', $plot->id)); ?>" class="btn btn-sm btn-info"><i class="ti ti-eye"></i></a>
                                    <a href="<?php echo e(route('plot.edit', $plot->id)); ?>" class="btn btn-sm btn-warning"><i class="ti ti-pencil"></i></a>
                                    <form action="<?php echo e(route('plot.destroy', $plot->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Delete?')">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr><td colspan="8" class="text-center"><?php echo e(__('No plots found.')); ?></td></tr>
                        <?php endif; ?>
                        </tbody>
                    </table>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AMS\main_file\resources\views/realEstate/plot/index.blade.php ENDPATH**/ ?>