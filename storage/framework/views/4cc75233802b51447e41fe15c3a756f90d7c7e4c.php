                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="number" step="0.01" min="0" name="area_acre"
                                                    class="form-control" value="<?php echo e(old('area_acre', $mouza->area_acre)); ?>"
                                                    placeholder="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="number" step="0.01" min="0" name="area_kanal"
                                                    class="form-control"
                                                    value="<?php echo e(old('area_kanal', $mouza->area_kanal)); ?>" placeholder="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="number" step="0.01" min="0" name="area_marla"
                                                    class="form-control"
                                                    value="<?php echo e(old('area_marla', $mouza->area_marla)); ?>" placeholder="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AMS\main_file\resources\views/realEstate/mouza/edit.blade.php ENDPATH**/ ?>