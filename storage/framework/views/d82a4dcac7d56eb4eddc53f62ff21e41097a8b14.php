...
<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Add Agricultural Land')); ?> - <?php echo e($project->name); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Add Agricultural Land')); ?></li>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('construction-project.field.store', $project->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" name="area_acre"
                                        class="form-control" value="<?php echo e(old('area_acre', 0)); ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <small id="map-hint"
                                class="text-muted"><?php echo e(__('Click on map to pin this field location')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-end">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="ti ti-check"></i>
                                <?php echo e(__('Save Field')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2026\Ezitech-AMS-main\resources\views/constructionProject/field/create.blade.php ENDPATH**/ ?>