...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('mouza.field.store', $mouza->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="available"
                                            ...
                                            Available</option>
                                        <option value="reserved" <?php echo e(old('status') == 'reserved' ? 'selected' : ''); ?>>🟡
                                            Reserved</option>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        (function() {
            ...
            var defaultLat = parseFloat(latInput.value) || <?php echo e($mouza->latitude ?? 31.5204); ?>;
            var defaultLng = parseFloat(lngInput.value) || <?php echo e($mouza->longitude ?? 74.3587); ?>;
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\2026\Ezitech-AMS-main\resources\views/realEstate/field/create.blade.php ENDPATH**/ ?>