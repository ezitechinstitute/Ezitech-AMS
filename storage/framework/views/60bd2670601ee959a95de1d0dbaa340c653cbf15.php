...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Add New')); ?></li>
<?php $__env->stopSection(); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('Add New Mouza (Area)')); ?></h5>
                </div>
                <div class="card-body">
                    <?php if($errors->any()): ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="number" step="0.01" min="0" name="area_acre"
                                                    class="form-control" value="<?php echo e(old('area_acre', 0)); ?>" placeholder="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="number" step="0.01" min="0" name="area_kanal"
                                                    class="form-control" value="<?php echo e(old('area_kanal', 0)); ?>"
                                                    placeholder="0">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3 mb-md-0">
                                                ...
                                                <input type="number" step="0.01" min="0" name="area_marla"
                                                    class="form-control" value="<?php echo e(old('area_marla', 0)); ?>"
                                                    placeholder="0">
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AMS\main_file\resources\views/realEstate/mouza/create.blade.php ENDPATH**/ ?>