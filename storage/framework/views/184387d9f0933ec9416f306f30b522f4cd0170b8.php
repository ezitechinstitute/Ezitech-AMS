...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        document.getElementById('mouza_id').addEventListener('change', function() {
            var mouzaId = this.value;
            var kiwatSelect = document.getElementById('kiwat_id');
            kiwatSelect.innerHTML = '<option value="">-- Select Khewat --</option>';
            if (!mouzaId) return;
            fetch('/kiwat/by-mouza/' + mouzaId)
                .then(res => res.json())
                .then(function(kiwats) {
