...
@section('page-title')
    {{ __('Create Construction Project') }}
@endsection
@section('breadcrumb')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('Add New Construction Project') }}</h5>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    @endif
                    <form action="{{ route('construction-project.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" required
                                        value="{{ old('name') }}" placeholder="e.g. Gulberg">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                            ...
                            <div class="col-12">
                                <div class="alert alert-light border mb-3">
                                    <h6 class="mb-3"><i class="ti ti-file-text"></i> {{ __('Master Intiqal Info') }}
                                        <small
                                            class="text-muted fw-normal">({{ __('bulk purchase record for this whole project, if applicable') }})</small>
                                    </h6>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <small id="map-hint"
                                class="text-muted">{{ __('Click on the map or drag the pin to set project location.') }}</small>
                        </div>

                        <div class="text-end mt-3">
                            <a href="{{ route('construction-project.index') }}"
