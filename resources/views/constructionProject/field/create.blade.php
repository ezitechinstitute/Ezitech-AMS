...
@section('page-title')
    {{ __('Add Agricultural Land') }} - {{ $project->name }}
@endsection
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Add Agricultural Land') }}</li>
@endsection

@section('content')
    <form action="{{ route('construction-project.field.store', $project->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-2">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="area_unit" class="form-control">
                                        <option value="Marla" {{ old('area_unit') == 'Marla' ? 'selected' : '' }}>Marla
                                        </option>
                                        <option value="Kanal" {{ old('area_unit') == 'Kanal' ? 'selected' : '' }}>Kanal
                                        </option>
                                        <option value="Acre" {{ old('area_unit') == 'Acre' ? 'selected' : '' }}>Acre
                                        </option>
                                        <option value="Sq Ft" {{ old('area_unit') == 'Sq Ft' ? 'selected' : '' }}>Sq Ft
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" name="area_acre"
                                        class="form-control" value="{{ old('area_acre', 0) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" name="area_kanal"
                                        class="form-control" value="{{ old('area_kanal', 0) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" name="area_marla"
                                        class="form-control" value="{{ old('area_marla', 0) }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                        ...
                        <div class="mb-2">
                            ...
                            <small id="map-hint"
                                class="text-muted">{{ __('Click on map to pin this field location') }}</small>
                        </div>
                    </div>
                </div>
            </div>
