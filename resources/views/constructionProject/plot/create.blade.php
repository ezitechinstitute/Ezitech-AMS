...
@section('content')
    <form action="{{ route('construction-project.plot.store', $project->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-2">
                            ...
                            <small id="map-hint"
                                class="text-muted">{{ __('Click on map to pin this plot location') }}</small>
                        </div>
                    </div>
                </div>
            </div>
