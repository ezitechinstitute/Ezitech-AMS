...
<head>
    <title>{{(Utility::getValByName('title_text')) ? Utility::getValByName('title_text') : config('app.name', 'Ezitech AMS')}} - @yield('page-title')</title>
        ...
        <div class="auth-footer">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 ">
                        <p class="">
                            {{(Utility::getValByName('footer_text')) ? Utility::getValByName('footer_text') :  __('Copyright Ezitech AMS') }} {{ date('Y') }}
                        </p>
                    </div>
                </div>
            </div>
