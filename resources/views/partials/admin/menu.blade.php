...
@endcan -->
                ...
                @if (Gate::check('manage mouza') || Gate::check('manage plot'))
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'mouza' || Request::segment(1) == 'plot' ? ' active dash-trigger' : '' }}">
                        ...
                        <ul
                            class="dash-submenu {{ Request::segment(1) == 'mouza' || Request::segment(1) == 'plot' ? 'show' : '' }}">
                            @can('manage mouza')
                            ...
                            @can('manage plot')
                                <li
                                    class="dash-item {{ Request::segment(1) == 'plot' && Request::segment(2) != 'inventory' ? 'active' : '' }}">
                ...
                @if (Gate::check('manage construction project'))
                    <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'construction-project' ? ' active dash-trigger' : '' }}">
                        <a href="#!" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-building"></i></span>
                            <span class="dash-mtext">{{ __('Construction Project Gulberg') }}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
                        <ul class="dash-submenu {{ Request::segment(1) == 'construction-project' ? 'show' : '' }}">
                            <li class="dash-item {{ Request::segment(2) == 'fields' ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('construction-project.field.index') }}">
                                    <i class="ti ti-map-pin me-1"></i>{{ __('Agricultural Land') }}
                                </a>
                            </li>
                            <li class="dash-item {{ Request::segment(2) == 'plots' ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('construction-project.plot.index') }}">
                                    <i class="ti ti-layout-grid me-1"></i>{{ __('Plots') }}
                                </a>
                            </li>
                        </ul>
                    ...
                    <li
                        ...
                        <ul
                            ...
                            @can('cash flow report')
                                <li
                                    class="dash-item {{ Request::route()->getName() == 'report.cash.flow' ? ' active' : '' }}">
                                    <a class="dash-link"
                                        href="{{ route('report.cash.flow') }}">{{ __('Cash Flow') }}</a>
                                </li>
                            @endcan
                            @can('stock report')
                                <li
