        ...
        <div class="col-12 mb-3">
            @if ($field->status == 'available')
                <div class="alert alert-primary mb-0">
                    <h5 class="mb-0">🔵 {{ __('Status: Available (Not Purchased)') }}</h5>
                </div>
            @else
                <div class="alert alert-success mb-0">
                    <h5 class="mb-0">🟢 {{ __('Status: Purchased') }}</h5>
                </div>
            @endif
        </div>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">{{ __('Field Information') }}</h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                            <td><strong>{{ __('Mouza') }}</strong></td>
                            <td>{{ $field->mouza->name }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><strong>PKR {{ number_format($field->amount, 2) }}</strong></td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Bank Account') }}</strong></td>
                            <td>{{ $field->bankAccount ? $field->bankAccount->bank_name . ' - ' . $field->bankAccount->account_number : '-' }}
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h5 class="mb-0">{{ __('Seller Details') }}</h5>
                </div>
                <div class="card-body">
                    <table class="table table-borderless">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{ $field->seller_father_name ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('CNIC') }}</strong></td>
                            <td>{{ $field->seller_cnic ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Phone') }}</strong></td>
                            <td>{{ $field->seller_phone ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Address') }}</strong></td>
                            <td>{{ $field->seller_address ?? '-' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            <td><strong>{{ __('CNIC') }}</strong></td>
                            <td>{{ $field->agent_cnic ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Phone') }}</strong></td>
                            <td>{{ $field->agent_phone ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Address') }}</strong></td>
                            <td>{{ $field->agent_address ?? '-' }}</td>
                        </tr>
                        <tr>
                            <td><strong>{{ __('Commission') }}</strong></td>
                            <td><strong>PKR {{ number_format($field->agent_commission, 2) }}</strong></td>
                        </tr>
                    </table>
                </div>
            </div>
