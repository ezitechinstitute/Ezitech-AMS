...
Route::prefix('mouza')->name('mouza.')->group(function () {

    // ===================== MOUZA CRUD =====================
    Route::get('/', [MouzaController::class, 'index'])->name('index');
    Route::get('/create', [MouzaController::class, 'create'])->name('create');
    Route::post('/', [MouzaController::class, 'store'])->name('store');
    Route::get('/{id}', [MouzaController::class, 'show'])->name('show');
    Route::get('/{id}/edit', [MouzaController::class, 'edit'])->name('edit');
    Route::put('/{id}', [MouzaController::class, 'update'])->name('update');
